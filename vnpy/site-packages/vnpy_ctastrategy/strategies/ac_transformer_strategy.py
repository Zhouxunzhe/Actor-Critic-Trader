...
class A2C_Tranformer_Strategy(CtaTemplate):
    author = "Xunzhe Zhou"
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        ...
        self.model_path = 'C:/Users/ZhouXunZhe/Desktop/quant/Actor-Critic-Trader/vnpy/checkpoints/a2c_transformer/a2c_transformer_model_AAPL.pth'
        self.input_dim = 4
        self.hidden_dim = 128
        self.action_dim = 3

        self.model = ActorCritic(self.input_dim, self.hidden_dim, self.action_dim, self.num_layers, self.num_heads)
