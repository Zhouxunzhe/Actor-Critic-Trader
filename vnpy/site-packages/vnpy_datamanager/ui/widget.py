...
class ImportDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.datetime_edit: QtWidgets.QLineEdit = QtWidgets.QLineEdit("Date")
        ...
        self.open_interest_edit: QtWidgets.QLineEdit = QtWidgets.QLineEdit("amount")

        self.format_edit: QtWidgets.QLineEdit = QtWidgets.QLineEdit("%Y-%m-%d")
