...
a2c_stats = [pd.read_csv(f'sh_plots/a2c/{i}3_perf.csv', index_col=0) for i in range(50)]
ddpg_stats = [pd.read_csv(f'sh_plots/ddpg/{i}3_perf.csv', index_col=0) for i in range(50)]
ppo_stats = [pd.read_csv(f'sh_plots/ppo/{i}3_perf.csv', index_col=0) for i in range(50)]
